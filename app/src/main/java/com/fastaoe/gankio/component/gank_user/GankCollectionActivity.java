...
public class GankCollectionActivity extends MyBaseActivity implements GankUserContract.View {
    ...
    public static void startGankCollectionActivity(Context context) {
        Intent intent = new Intent(context, GankCollectionActivity.class);
    ...
    protected void initData() {
        gankUserPresenter.showContent(GankUserPresenter.QUERY_COLLECTION);
        initRecycle();
    }
                    ...
                    holder.setText(R.id.tv_saved_time, DateUtil.DateToStr(data.getCollectionedAt()))
                            ...
                            .setImagePath(R.id.iv_images, new ViewHolder.HolderImageLoader(data.getImages()) {
                                ...
                                public void loadImage(ImageView imageView, String path) {
                                    ...
                                    Glide.with(GankCollectionActivity.this).load(imageUrl).into(imageView);
                                }
                            });
                } else {
                    // no images
