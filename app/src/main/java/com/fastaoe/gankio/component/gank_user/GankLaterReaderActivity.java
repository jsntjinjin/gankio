...
public class GankLaterReaderActivity extends MyBaseActivity implements GankUserContract.View{
    ...
    public static void startGankLaterReaderActivity(Context context) {
        Intent intent = new Intent(context, GankLaterReaderActivity.class);
    ...
    protected void initData() {
        gankUserPresenter.showContent(GankUserPresenter.QUERY_LATER_READER);
        initRecycle();
    }
                    ...
                    holder.setText(R.id.tv_saved_time, DateUtil.DateToStr(data.getCollectionedAt()))
                            ...
                            .setImagePath(R.id.iv_images, new ViewHolder.HolderImageLoader(data.getImages()) {
                                ...
                                public void loadImage(ImageView imageView, String path) {
                                    ...
                                    Glide.with(GankLaterReaderActivity.this).load(imageUrl).into(imageView);
                                }
                            });
                } else {
                    // no images
